...
const tabs = [
  { name: 'Aktivni kandidati', href: '#', current: true },
  { name: 'Neaktivni kandidati', href: '#', current: false },
  { name: 'Inštruktorji', href: '#', current: false },
  { name: 'Administratorji', href: '#', current: false },
]
        ...
        <div className="sm:flex sm:items-center">
          <div className="sm:flex-auto">
            ...
            <p className="mt-2 text-sm text-gray-700">
              Dodajte uporabnika po želji, novega inštruktorja, kandidata ali administratorja
            </p>
          </div>
