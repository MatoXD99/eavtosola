...
import CarSVG from '../images/undraw_order_ride_re_372k.svg'

const navigation = [
    { name: 'Funkcionalnosti', href: '/features' },
    { name: 'Produkt', href: '/product' },
    { name: 'Cenitev', href: '/pricing' },
]
const features = [
    {
        name: 'Push to Deploy',
...
const blogPosts = [
    {
        ...
        date: 'Mar 16, 2020',
        datetime: '2020-03-16',
        category: { name: 'Article', href: '/empty' },
        imageUrl:
    ...
    },
    {
        ...
        date: 'Mar 10, 2020',
        datetime: '2020-03-10',
        category: { name: 'Video', href: '/empty' },
        imageUrl:
    ...
    },
    {
        ...
        date: 'Feb 12, 2020',
        datetime: '2020-02-12',
        category: { name: 'Case Study', href: '/empty' },
        imageUrl:
...
const footerNavigation = {
    solutions: [
        { name: 'Marketing', href: '/empty' },
        { name: 'Analytics', href: '/empty' },
        { name: 'Commerce', href: '/empty' },
        { name: 'Insights', href: '/empty' },
    ],
    support: [
        { name: 'Pricing', href: '/empty' },
        { name: 'Documentation', href: '/empty' },
        { name: 'Guides', href: '/empty' },
        { name: 'API Status', href: '/empty' },
    ],
    company: [
        { name: 'About', href: '/empty' },
        { name: 'Blog', href: '/empty' },
        { name: 'Jobs', href: '/empty' },
        { name: 'Press', href: '/empty' },
        { name: 'Partners', href: '/empty' },
    ],
    legal: [
        { name: 'Claim', href: '/empty' },
        { name: 'Privacy', href: '/empty' },
        { name: 'Terms', href: '/empty' },
    ],
    social: [
        {
            name: 'Facebook',
                                ...
                                <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                                    <div className="lg:py-24">
                                        ...
                                        <h1 className="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                                            <span className="block">eAvtoŠola</span>
                                            <span className="pb-3 block bg-clip-text text-transparent bg-gradient-to-r from-teal-200 to-cyan-400 sm:pb-5">
                                                povežimo avtošolski sistem v enotnost
                                            </span>
                                        </h1>
                                        <p className="text-base text-gray-300 sm:text-xl lg:text-lg xl:text-xl">
                                            Podjetje Applia.si je razvila aplikacijo eAvtoŠola z namenom, da se proces opravljanja izpita poenostavi in poenoti.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div className="mx-auto max-w-md px-4 text-center sm:px-6 sm:max-w-3xl lg:px-8 lg:max-w-7xl">
                            <div>
                                ...
                                <p className="mt-5 max-w-prose mx-auto text-xl text-gray-500">
                                    eAvtoŠola ponuja vrsto funkcij, ki vam bodo olajšale delo in sledenje procesu opravljanja izpita. Tako lahko sledite preko računalnika ali iz telefona.
                                </p>
                            </div>
